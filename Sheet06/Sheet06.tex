...
\begin{enumerate}
    \item First let's recall what finitely generated and finitely presented meant.
        ...
        \end{tikzcd}\]
        It may not be clear why the top and bottom row are exact. Here we will
        also not give a complete answer. But the exactness of the top row
        follows directly by the fact that the tensor product is right exact
        (a good way to remember what right-exactness means is to remember that
        right-exact functors \textit{turn cokernels into cokernels}),
        and exactness of the bottom row follows from the fact that products
        are exact (not in general for abelian categories but in the case of the 
        category of $R$-modules). You'll have to find out what that last
        sentence means by yourself.
