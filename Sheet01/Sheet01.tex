...
\begin{enumerate}
    ...
    \item \textit{Nilradical and Jacobson radical.} We claim that if $I \subset
        ...
        we have $I \subset \fm$ for every maximal ideal, hence $(\varepsilon)
        \subset \Jac(A)$. As $A/(\varepsilon) \cong k[T]$, we have 
        $(0) = \Nil(A/(\varepsilon)) = \Nil(A) / (\varepsilon)$. This shows 
        $\Nil(A) \subset (\varepsilon)$, and we obtain 
        \begin{equation*}
            (\varepsilon) \subset \Jac(A) \subset \Nil(A) \subset (\varepsilon).
        \end{equation*}
        Done.  
